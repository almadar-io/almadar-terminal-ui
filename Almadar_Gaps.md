...
- **Codes:** new gaps use this repo's prefix `G-TERMINAL-UI-`. Take the "Next code" below, then bump it in the same edit. Codes are never reused or renamed.
